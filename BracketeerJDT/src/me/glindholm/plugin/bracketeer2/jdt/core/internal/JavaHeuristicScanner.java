...
public final class JavaHeuristicScanner implements Symbols {
     ...
     */
    public JavaHeuristicScanner(final IDocument document, final String partitioning, final String partition) {
     ...
     * @param document the document to scan.
     */
    public JavaHeuristicScanner(final IDocument document) {
    ...
    public IRegion findSurroundingBlock(final int offset) {
        ...
        final int begin = findOpeningPeer(offset - 1, LBRACE, RBRACE);
        final int end = findClosingPeer(offset, LBRACE, RBRACE);
     ...
     * <code>position</code> and &gt; <code>bound</code> and
     * <code>Character.isWhitespace(fDocument.getChar(pos))</code> evaluates to <code>false</code> and
     * the position can be in any partition.
     * 
     * @param position the first character position in <code>fDocument</code> to be considered
     * @param bound    the first position in <code>fDocument</code> to not consider any more, with
     *                 <code>bound</code> &lt; <code>position</code>, or <code>UNBOUND</code>
     ...
     * @since 3.7
     */
    public int findNonWhitespaceBackwardInAnyPartition(final int position, final int bound) {
     ...
     * @since 3.2
     */
    public static boolean isGenericStarter(final CharSequence identifier) {
        /*
         * This heuristic allows any identifiers if they start with an upper case. This will fail when a
         * comparison is made with constants:
         *
         * if (MAX > foo)
         *
