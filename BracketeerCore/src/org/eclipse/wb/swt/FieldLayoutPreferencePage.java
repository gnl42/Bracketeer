...
/**
 * A special abstract preference page to host field editors and eny other controls with flexible
 * layout.
 * <p>
...
public abstract class FieldLayoutPreferencePage extends PreferencePage implements IPropertyChangeListener {
     ...
     */
    protected FieldLayoutPreferencePage(final String title) {
        super(title);
    }
     ...
     */
    protected FieldLayoutPreferencePage(final String title, final ImageDescriptor image) {
        super(title, image);
    }
     ...
     * <code>GridLayout</code>) are expected to set the margins of this <code>Layout</code> to 0 pixels.
     * </p>
     *
    ...
    /**
     * The field editor preference page implementation of an <code>IDialogPage</code> method disposes of
     * this page's controls and images. Subclasses may override to release their own allocated SWT
    ...
    public void dispose() {
        super.dispose();
        if (m_fields != null) {
            for (final FieldEditor editor : m_fields) {
                editor.setPage(null);
    ...
    /**
     * The field editor preference page implementation of a <code>PreferencePage</code> method loads all
     * the field editors with their default values.
     */
    @Override
    ...
    /**
     * The field editor preference page implementation of this <code>PreferencePage</code> method saves
     * all field editors by calling <code>FieldEditor.store</code>. Note that this method does not save
     * the preference store itself; it just stores the values back into the preference store.
     *
