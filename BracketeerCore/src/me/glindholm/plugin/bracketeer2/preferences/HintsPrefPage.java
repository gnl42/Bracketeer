 ...
 *******************************************************************************/
package me.glindholm.plugin.bracketeer2.preferences;
...
import me.glindholm.plugin.bracketeer2.core.ProcessorsRegistry;
...
public class HintsPrefPage extends ChangingFieldsPrefPage implements IWorkbenchPreferencePage {
    ...
    class FEInfo {
        ...
        public FEInfo(final FieldEditor fe, final String attrSuffix) {
            _fe = fe;
    ...
    public Control createPageContents(final Composite parent) {
        ...
        final IConfigurationElement[] config = Platform.getExtensionRegistry().getConfigurationElementsFor(ProcessorsRegistry.PROC_FACTORY_ID);
...
//        IConfigurationElement element = null; // stub
        for (final IConfigurationElement element : config) {
            ...
            tabInfo._dynamicFe = new ArrayList<>();
            final String basePref = PreferencesConstants.Hints.preferencePath(pluginName, PreferencesConstants.Hints.DEFAULT_TYPE);
            ...
            if (hints.length == 0) {
                final Label lable = new Label(composite, NONE);
            ...
            BooleanFieldEditor bfe = new BooleanFieldEditor(PreferencesConstants.preferencePath(pluginName) + PreferencesConstants.Hints.Hover.ENABLE,
                    Messages.HintsPrefPage_HintOnHover, BooleanFieldEditor.DEFAULT, composite_3);
            addField(bfe);
            tabInfo._hoverEn = bfe;

            final Composite composite_24 = new Composite(composite, SWT.NONE);
            final GridLayout gl_composite_24 = new GridLayout(1, false);
            ...
            final Composite composite_23 = new Composite(composite_24, SWT.NONE);

            SpinnerFieldEditor spinner = new SpinnerFieldEditor(PreferencesConstants.preferencePath(pluginName) + PreferencesConstants.Hints.Hover.MAX_LEN,
            ...
            final Group grpHintsConfiguration = new Group(composite, SWT.NONE);
...
//                                            "Display tooltip on hover", BooleanFieldEditor.DEFAULT, composite_3));
            ...
            final Composite composite_1 = new Composite(grpHintsConfiguration, SWT.NONE);
            ...
            final List list = new List(composite_4, SWT.BORDER);
            ...
            for (final IConfigurationElement hint : hints) {
                final String hintType = hint.getAttribute("type"); //$NON-NLS-1$
                list.add(hintType);
            }
            list.setSelection(0);
            ...
            final Group grpWhenToShow = new Group(composite_5, SWT.NONE);
            grpWhenToShow.setText(Messages.HintsPrefPage_WhenToShow);
            grpWhenToShow.setLayout(new GridLayout(1, false));

            final Composite composite_6 = new Composite(grpWhenToShow, SWT.NONE);
            bfe = new BooleanFieldEditor(basePref + PreferencesConstants.Hints.WhenToShow.USE_DEFAULT, Messages.HintsPrefPage_UseDef,
                    BooleanFieldEditor.DEFAULT, composite_6);
            addField(bfe);
            ...
            final Composite composite_15 = new Composite(grpWhenToShow, SWT.NONE);
            final GridLayout gl_composite_15 = new GridLayout(1, false);
            gl_composite_15.marginLeft = 10;
            composite_15.setLayout(gl_composite_15);

            final Composite composite_7 = new Composite(composite_15, SWT.NONE);
            bfe = new BooleanFieldEditor(basePref + PreferencesConstants.Hints.WhenToShow.SHOW_IN_EDITOR, Messages.HintsPrefPage_DisplayHintsInEditor,
            ...
            final Composite composite_14 = new Composite(composite_15, SWT.NONE);
            spinner = new SpinnerFieldEditor(basePref + PreferencesConstants.Hints.WhenToShow.MIN_LINES_DISTANCE, Messages.HintsPrefPage_MinLines,
                    composite_14);
            addField(spinner);
            ...
            final Composite composite_20 = new Composite(composite_5, SWT.NONE);
            composite_20.setLayout(new GridLayout(2, false));

            final Group grpFont = new Group(composite_20, SWT.NONE);
            ...
            final Composite composite_8 = new Composite(grpFont, SWT.NONE);
            bfe = new BooleanFieldEditor(basePref + PreferencesConstants.Hints.Font.USE_DEFAULT, Messages.HintsPrefPage_UseDef, BooleanFieldEditor.DEFAULT,
                    composite_8);
            addField(bfe);
            ...
            final Composite composite_9 = new Composite(grpFont, SWT.NONE);
            composite_9.setBounds(0, 0, 64, 64);
            final GridLayout gl_composite_9 = new GridLayout(1, false);
            gl_composite_9.marginLeft = 10;
            composite_9.setLayout(gl_composite_9);
            tabInfo._fontGrp = composite_9;

            final Group grpForegroundColor = new Group(composite_9, SWT.NONE);
            grpForegroundColor.setText(Messages.HintsPrefPage_FgColor);
            grpForegroundColor.setLayout(new GridLayout(1, false));

            final Composite composite_21 = new Composite(grpForegroundColor, SWT.NONE);
            bfe = new BooleanFieldEditor(basePref + PreferencesConstants.Hints.Font.FG_DEFAULT, Messages.HintsPrefPage_UseSysDef, BooleanFieldEditor.DEFAULT,
                    composite_21);
            addField(bfe);
            ...
            ColorFieldEditor cfe = new ColorFieldEditor(basePref + PreferencesConstants.Hints.Font.FG_COLOR, Messages.HintsPrefPage_Color, composite_10);
            addField(cfe);
            addDynamicFE(tabInfo, cfe, PreferencesConstants.Hints.Font.FG_COLOR);
            tabInfo._fontFgColor = composite_10;

            final Group grpBackgroundColor = new Group(composite_9, SWT.NONE);
            grpBackgroundColor.setText(Messages.HintsPrefPage_BgColor);
            grpBackgroundColor.setLayout(new GridLayout(1, false));

            final Composite composite_22 = new Composite(grpBackgroundColor, SWT.NONE);
            bfe = new BooleanFieldEditor(basePref + PreferencesConstants.Hints.Font.BG_DEFAULT, Messages.HintsPrefPage_UseSysDef, BooleanFieldEditor.DEFAULT,
                    composite_22);
            addField(bfe);
            addDynamicFE(tabInfo, bfe, PreferencesConstants.Hints.Font.BG_DEFAULT);
            tabInfo._fontBgDef = bfe;

            final Composite composite_11 = new Composite(grpBackgroundColor, SWT.NONE);
            cfe = new ColorFieldEditor(basePref + PreferencesConstants.Hints.Font.BG_COLOR, Messages.HintsPrefPage_Color, composite_11);
            addField(cfe);
            addDynamicFE(tabInfo, cfe, PreferencesConstants.Hints.Font.BG_COLOR);
            tabInfo._fontBgColor = composite_11;

            final Composite composite_12 = new Composite(composite_9, SWT.NONE);
            bfe = new BooleanFieldEditor(basePref + PreferencesConstants.Hints.Font.ITALIC, Messages.HintsPrefPage_Italic, BooleanFieldEditor.DEFAULT,
                    composite_12);
            addField(bfe);
            addDynamicFE(tabInfo, bfe, PreferencesConstants.Hints.Font.ITALIC);

            final Group grpShow = new Group(composite_20, SWT.NONE);
            ...
            final Composite composite_13 = new Composite(grpShow, SWT.NONE);
            bfe = new BooleanFieldEditor(basePref + PreferencesConstants.Hints.Display.USE_DEFAULT, Messages.HintsPrefPage_UseDef, BooleanFieldEditor.DEFAULT,
                    composite_13);
            addField(bfe);
            ...
            final Composite composite_18 = new Composite(grpShow, SWT.NONE);
            final GridLayout gl_composite_18 = new GridLayout(1, false);
            gl_composite_18.marginLeft = 10;
            composite_18.setLayout(gl_composite_18);
            tabInfo._displayGrp = composite_18;

            final Composite composite_19 = new Composite(composite_18, SWT.NONE);
            spinner = new SpinnerFieldEditor(basePref + PreferencesConstants.Hints.Display.MAX_LENGTH, Messages.HintsPrefPage_MaxLen, composite_19);
            addField(spinner);
            addDynamicFE(tabInfo, spinner, PreferencesConstants.Hints.Display.MAX_LENGTH);

            final Composite composite_17 = new Composite(composite_18, SWT.NONE);
            bfe = new BooleanFieldEditor(basePref + PreferencesConstants.Hints.Display.STRIP_WHITESPACE, Messages.HintsPrefPage_StipWhitespace,
                    BooleanFieldEditor.DEFAULT, composite_17);
            addField(bfe);
            addDynamicFE(tabInfo, bfe, PreferencesConstants.Hints.Display.STRIP_WHITESPACE);

            final Composite composite_16 = new Composite(composite_18, SWT.NONE);
            {
                final RadioGroupFieldEditor radioGroupFieldEditor = new RadioGroupFieldEditor(basePref + PreferencesConstants.Hints.Display.Ellipsis.ATTR,
    ...
    private void addDynamicFE(final TabInfo tabInfo, final FieldEditor fe, final String attrSuffix) {
    ...
    protected void initialize() {
        for (final TabInfo tabInfo : _tabInfos) {
            ...
            for (final String type : tabInfo._hintsList.getItems()) {
                final String basePref = PreferencesConstants.Hints.preferencePath(tabInfo._name, type);
...
//                _prefNames.add(basePref + PreferencesConstants.Hints.WhenToShow.Criteria.ATTR);
                ...
                for (final FEInfo feInfo : tabInfo._dynamicFe) {
    ...
    public void propertyChange(final PropertyChangeEvent event) {
        ...
        for (final TabInfo tabInfo : _tabInfos) {
            if (event.getSource() == tabInfo._displayUseDef || event.getSource() == tabInfo._fontUseDef || event.getSource() == tabInfo._whenToShowUseDef
                    || event.getSource() == tabInfo._fontBgDef || event.getSource() == tabInfo._fontFgDef || event.getSource() == tabInfo._showInEditor
    ...
    protected void updateHintFieldEditors() {
        for (final TabInfo tabInfo : _tabInfos) {
            ...
            final int idx = tabInfo._hintsList.getSelectionIndex();
            String type;
            if (idx == 0) {
            ...
            boolean disableAll;
            {
                ...
                final String prefToCheck = PreferencesConstants.Hints.preferencePath(tabInfo._name, typeToCheck)
