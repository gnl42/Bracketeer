                                            ...
                                            List<PaintableBracket> paintableObjectsList)
    {
        ...
        for (SingleBracket bracket : listOfSingles)
        {
                ...
                _resource != null && _annotationMap != null )
            {
                try
                {
                    IMarker marker = _resource.createMarker("me.glindholm.plugin.bracketeer2.unmatchedBracket.marker"); //$NON-NLS-1$

                    SimpleMarkerAnnotation ma = 
                            new SimpleMarkerAnnotation("me.glindholm.plugin.bracketeer2.unmatchedBracket.annotation",  //$NON-NLS-1$
                                                       marker);
