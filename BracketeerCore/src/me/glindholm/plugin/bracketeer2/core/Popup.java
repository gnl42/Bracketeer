...
public class Popup implements IDisposable, PaintListener {
    ...
    public Popup(final ISourceViewer parentSv, final StyledText parentSt, final IDocument origDoc, final PaintableBracket paintBracket)
    ...
    private void updatePopupContent(final SourceViewer sv, final ISourceViewer parentSv, final StyledText parentSt, final IDocument origDoc,
            final PaintableBracket paintBracket) throws BadLocationException {
        ...
        final Position origPos = paintBracket.getPosition();
    ...
    public void paintControl(final PaintEvent event) {
        ...
        _bracketToPaint.paint(event.gc, _sourceViewer.getTextWidget(), _sourceViewer.getDocument(),
                new Region(_bracketToPaint.getPosition().getOffset(), _bracketToPaint.getPosition().getLength()), null);
    }
}
