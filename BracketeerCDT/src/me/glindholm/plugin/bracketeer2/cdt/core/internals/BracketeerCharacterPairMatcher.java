...
public class BracketeerCharacterPairMatcher  
{
    ...
    private static class DocumentPartitionAccessor {
         ...
         */
        public DocumentPartitionAccessor(IDocument doc, List<Position> inactiveCode, String partitioning,
                String partition) {
            fDocument= doc;
            fPartitioning= partitioning;
        ...
        private ITypedRegion intersect(ITypedRegion region,
                                       Position pos, String suffix )
        {
            if( pos == null )
                return region;
        ...
        {
            Position ret = null;
            for (Position inactivePos : fInactiveCode)
            {
